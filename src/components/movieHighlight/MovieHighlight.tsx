...
export default function MovieHighlight({ direction = "left", noRotate = false }: MovieHighlightProps) {
  const movies = [
    {
  ...
  return (
    <section className="py-4">
      <div className="relative w-full overflow-hidden">
        <div
          className={`flex ${
            noRotate ? "" : direction === "left" ? "highlights-slider-left" : "highlights-slider-right"
          }`}>

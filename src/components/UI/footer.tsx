    ...
    <footer className={styles.footer} role="contentinfo" aria-label="Site footer">
      ...
      <nav aria-label="Footer navigation">
        <ul className={styles.linksContainer}>
          <li>
            <a href="https://apps.apple.com/se/app/easybudget/id6446150580?l=en-GB" target="_blank" rel="noopener noreferrer">
              EasyBudget
            </a>
            <a href="https://github-follower-manager.vercel.app/" target="_blank" rel="noopener noreferrer">
              GitHub-Manager
            </a>
            <a href="https://wordle-gpt.vercel.app/" target="_blank" rel="noopener noreferrer">
              WordleGPT
            </a>
          </li>
        </ul>
